...
<div class="container cont">
    ...
    <form action="<?php echo e(route('finalizar_compra')); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-4">
            ...
            <div class="col-4">
                Total da compra:
                <input type="text" name="totalfinal" class="totalfinal form-control" value="R$ <?php echo number_format($total, 2, ',','.'); ?>">
            </div>
            <div class="col-4">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\amilt\OneDrive\Área de Trabalho\PI\DEMADANSTORE\demadan\resources\views/produtos/pagar.blade.php ENDPATH**/ ?>