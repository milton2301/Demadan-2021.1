...
<div class="col-12">
    <table class="table table-bordered">
        ...
        <?php $__currentLoopData = $pedidos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lista): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <?php if($lista->statusDesc() == "FINALIZADO" || $lista->statusDesc() == "CANCELAR"): ?>
                <tr>
...
<?php echo $__env->make('layout.layoutAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\amilt\OneDrive\Área de Trabalho\PI\DEMADANSTORE\demadan\resources\views/admin/pedidosAtendidos.blade.php ENDPATH**/ ?>